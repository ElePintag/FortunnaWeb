        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="https://wa.me/593959185490" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-fortunna-gold transition-colors text-sm">
                  0959 185 490
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-fortunna-gold flex-shrink-0" />
                <a href="mailto:fortunnainmobiliaria@gmail.com" className="text-gray-400 hover:text-fortunna-gold transition-colors text-sm">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.facebook.com/profile.php?id=61577868596199"
                target="_blank"
