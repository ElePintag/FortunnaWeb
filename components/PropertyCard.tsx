      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 group">
        ...
        <div className="p-6">
          ...
          <div className="pt-4 border-t border-gray-200">
            <div className="bg-fortunna-red/20 text-fortunna-red px-4 py-3 rounded-lg font-bold text-center group-hover:bg-fortunna-red group-hover:text-white group-hover:scale-110 group-hover:shadow-xl transition-all duration-300 shadow-md flex items-center justify-center space-x-2">
